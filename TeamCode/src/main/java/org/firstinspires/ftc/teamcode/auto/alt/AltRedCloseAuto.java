...
@Autonomous(name = "Red Close", group = "Alt")
public class AltRedCloseAuto extends LinearOpMode {
    ...
    private void telemetryTfod() {
        ...
        for (Recognition recognition : currentRecognitions) {
            ...
            if (recognition.getLabel().equals("Red")) {
                drive.followTrajectorySequence(AltRedClose.auto(recognition.estimateAngleToObject(AngleUnit.DEGREES), drive, arm));
